...
int run(cl_mem input, cl_mem output, gan_buffer_t &buf, model &cycleGAN,
  ...
  conv2d_exec_async(queue, buf.r0_0, cycleGAN.m_10.r_1.weight_buf,
                    ...
                    cycleGAN.m_10.r_2.variance_buf, 256, 66, 66, 256,
                    64, 64,1, 3, 3, true,
                    activation::RELU);
  reflectpad_2d(queue, buf.r0_1, buf.r0_2, 256, 64, 64, 1);
  conv2d_exec_async(queue, buf.r0_2, cycleGAN.m_10.r_5.weight_buf,
                    ...
                    cycleGAN.m_10.r_6.variance_buf, 256, 66, 66, 256,
                    64, 64,1, 3, 3, true,
                    activation::NONE);
  ...
  // resnet block 1
  reflectpad_2d(queue, buf.r0_3, buf.r1_0, 256, 64, 64, 1);
  conv2d_exec_async(queue, buf.r1_0, cycleGAN.m_11.r_1.weight_buf,
                    ...
                    cycleGAN.m_11.r_2.variance_buf, 256, 66, 66, 256,
                    64, 64,1, 3, 3, true,
                    activation::RELU);
  reflectpad_2d(queue, buf.r1_1, buf.r1_2, 256, 64, 64, 1);
  conv2d_exec_async(queue, buf.r1_2, cycleGAN.m_11.r_5.weight_buf,
                    ...
                    cycleGAN.m_11.r_6.variance_buf, 256, 66, 66, 256,
                    64, 64,1, 3, 3, true,
                    activation::NONE);
  ...
  // resnet block 2
  reflectpad_2d(queue, buf.r1_3, buf.r2_0, 256, 64, 64, 1);
  conv2d_exec_async(queue, buf.r2_0, cycleGAN.m_12.r_1.weight_buf,
                    ...
                    cycleGAN.m_12.r_2.variance_buf, 256, 66, 66, 256,
                    64, 64,1, 3, 3, true,
                    activation::RELU);
  reflectpad_2d(queue, buf.r2_1, buf.r2_2, 256, 64, 64, 1);
  conv2d_exec_async(queue, buf.r2_2, cycleGAN.m_12.r_5.weight_buf,
                    ...
                    cycleGAN.m_12.r_6.variance_buf, 256, 66, 66, 256,
                    64, 64,1, 3, 3, true,
                    activation::NONE);
  ...
  // resnet block 3
  reflectpad_2d(queue, buf.r2_3, buf.r3_0, 256, 64, 64, 1);
  conv2d_exec_async(queue, buf.r3_0, cycleGAN.m_13.r_1.weight_buf,
                    ...
                    cycleGAN.m_13.r_2.variance_buf, 256, 66, 66, 256,
                    64, 64,1, 3, 3, true,
                    activation::RELU);
  reflectpad_2d(queue, buf.r3_1, buf.r3_2, 256, 64, 64, 1);
  conv2d_exec_async(queue, buf.r3_2, cycleGAN.m_13.r_5.weight_buf,
                    ...
                    cycleGAN.m_13.r_6.variance_buf, 256, 66, 66, 256,
                    64, 64,1, 3, 3, true,
                    activation::NONE);
  ...
  // resnet block 4
  reflectpad_2d(queue, buf.r3_3, buf.r4_0, 256, 64, 64, 1);
  conv2d_exec_async(queue, buf.r4_0, cycleGAN.m_14.r_1.weight_buf,
                    ...
                    cycleGAN.m_14.r_2.variance_buf, 256, 66, 66, 256,
                    64, 64,1, 3, 3, true,
                    activation::RELU);
  reflectpad_2d(queue, buf.r4_1, buf.r4_2, 256, 64, 64, 1);
  conv2d_exec_async(queue, buf.r4_2, cycleGAN.m_14.r_5.weight_buf,
                    ...
                    cycleGAN.m_14.r_6.variance_buf, 256, 66, 66, 256,
                    64, 64,1, 3, 3, true,
                    activation::NONE);
  ...
  // resnet block 5
  reflectpad_2d(queue, buf.r4_3, buf.r5_0, 256, 64, 64, 1);
  conv2d_exec_async(queue, buf.r5_0, cycleGAN.m_15.r_1.weight_buf,
                    ...
                    cycleGAN.m_15.r_2.variance_buf, 256, 66, 66, 256,
                    64, 64,1, 3, 3, true,
                    activation::RELU);
  reflectpad_2d(queue, buf.r5_1, buf.r5_2, 256, 64, 64, 1);
  conv2d_exec_async(queue, buf.r5_2, cycleGAN.m_15.r_5.weight_buf,
                    ...
                    cycleGAN.m_15.r_6.variance_buf, 256, 66, 66, 256,
                    64, 64,1, 3, 3, true,
                    activation::NONE);
  ...
  // resnet block 6
  reflectpad_2d(queue, buf.r5_3, buf.r6_0, 256, 64, 64, 1);
  conv2d_exec_async(queue, buf.r6_0, cycleGAN.m_16.r_1.weight_buf,
                    ...
                    cycleGAN.m_16.r_2.variance_buf, 256, 66, 66, 256,
                    64, 64,1, 3, 3, true,
                    activation::RELU);
  reflectpad_2d(queue, buf.r6_1, buf.r6_2, 256, 64, 64, 1);
  conv2d_exec_async(queue, buf.r6_2, cycleGAN.m_16.r_5.weight_buf,
                    ...
                    cycleGAN.m_16.r_6.variance_buf, 256, 66, 66, 256,
                    64, 64,1, 3, 3, true,
                    activation::NONE);
  ...
  // resnet block 7
  reflectpad_2d(queue, buf.r6_3, buf.r7_0, 256, 64, 64, 1);
  conv2d_exec_async(queue, buf.r7_0, cycleGAN.m_17.r_1.weight_buf,
                    ...
                    cycleGAN.m_17.r_2.variance_buf, 256, 66, 66, 256,
                    64, 64,1, 3, 3, true,
                    activation::RELU);
  reflectpad_2d(queue, buf.r7_1, buf.r7_2, 256, 64, 64, 1);
  conv2d_exec_async(queue, buf.r7_2, cycleGAN.m_17.r_5.weight_buf,
                    ...
                    cycleGAN.m_17.r_6.variance_buf, 256, 66, 66, 256,
                    64, 64,1, 3, 3, true,
                    activation::NONE);
  ...
  // resnet block 8
  reflectpad_2d(queue, buf.r7_3, buf.r8_0, 256, 64, 64, 1);
  conv2d_exec_async(queue, buf.r8_0, cycleGAN.m_18.r_1.weight_buf,
                    ...
                    cycleGAN.m_18.r_2.variance_buf, 256, 66, 66, 256,
                    64, 64,1, 3, 3, true,
                    activation::RELU);
  reflectpad_2d(queue, buf.r8_1, buf.r8_2, 256, 64, 64, 1);
  conv2d_exec_async(queue, buf.r8_2, cycleGAN.m_18.r_5.weight_buf,
                    ...
                    cycleGAN.m_18.r_6.variance_buf, 256, 66, 66, 256,
                    64, 64,1, 3, 3, true,
                    activation::NONE);
  ...
  conv2d_transpose_3x3_stride2_norm_relu_exec_async(queue, buf.r8_3, cycleGAN.m_19.weight_buf, cycleGAN.m_19.bias_buf,
      buf.o_4, cycleGAN.m_20.mean_buf, cycleGAN.m_20.variance_buf, 256, 64, 64,
      128, 128, 128, true, activation::RELU);
  ...
  conv2d_transpose_3x3_stride2_norm_relu_exec_async(queue, buf.o_4, cycleGAN.m_22.weight_buf, cycleGAN.m_22.bias_buf,
      buf.o_5, cycleGAN.m_23.mean_buf, cycleGAN.m_23.variance_buf, 128, 128, 128,
      64, 256, 256, true, activation::RELU);
  showtime("conv transpose");

  // conv
  reflectpad_2d(queue, buf.o_5, buf.o_6, 64, 256, 256, 3);
  conv2d_exec_async(queue, buf.o_6, cycleGAN.m_26.weight_buf, cycleGAN.m_26.bias_buf, output, nullptr,
                    nullptr, 64, 262, 262, 4,
                    256, 256,1, 7, 7, false,
                    activation::TANH);
  showtime("conv last");
  clFinish(queue);
