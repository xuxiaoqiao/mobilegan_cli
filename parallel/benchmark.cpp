...
void benchmark_run() {
  BenchmarkConv bench;
  bench.run(conv2d_variant::NHWC_VER4, 3);
  bench.run(conv2d_variant::NHWC_VER3, 3);
  bench.run(conv2d_variant::NHWC_VER2, 3);
  bench.run(conv2d_variant::NCHW4_INTERLEAVE, 3);
  bench.run(conv2d_variant::NCHW4_INTERLEAVE_VER2, 3);
